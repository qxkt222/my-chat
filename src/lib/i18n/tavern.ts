...
export const tavernMessages: Record<string, Record<string, string>> = {
  ...
  // ── 全局条目名册（2026-09-25）──
  "preset.collapse": { zh: "收起", en: "Collapse" },
  "preset.builtinTag": { zh: "(内置)", en: "(built-in)" },
  "preset.moveUp": { zh: "上移（提前拼装）", en: "Move up" },
  "preset.moveDown": { zh: "下移（推后拼装）", en: "Move down" },
  "preset.charCount": { zh: "{n} 字", en: "{n} chars" },
  "preset.groupCount": { zh: "启用 {on}/{all}", en: "{on}/{all} on" },
  "preset.groupOn": { zh: "整包开启", en: "Enable all" },
  "preset.groupOff": { zh: "整包关闭", en: "Disable all" },
  "preset.enabledSummary": {
    zh: "已启用 {n} 条 · 合计 {chars} 字 / 约 {tokens} token（预算 {budget}）",
    en: "{n} on · {chars} chars / ~{tokens} tokens (budget {budget})",
  },
  "preset.overBudget": { zh: "已超出上下文预算（仍可发送）", en: "Over budget (still sendable)" },
